...
<head>
    ...
    <meta name="description" content="Apotek Rahmayani">
    <meta name="author" content="Ade Irfan Imanda">
    ...
    <footer class="footer bg-white shadow mt-auto py-3">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center">
                <div class="copyright">
                    &copy; 2024 - <a href="/" target="_blank" class="fw-semibold">Apotek Rahmayani</a>. All rights
                    reserved.
                </div>
            </div>
        </div>
